...
format = pyaudio.paFloat32  # PyAudio format

# Initialize the Wiener filter for real-time processing
wiener_filter = nr.RealTimeWiener(fs)
...
original_wave = wave.open('original_audio.wav', 'wb')
processed_wave = wave.open('processed_audio.wav', 'wb')
